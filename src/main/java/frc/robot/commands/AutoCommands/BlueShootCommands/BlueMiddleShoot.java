...
public class BlueMiddleShoot extends SequentialCommandGroup {

    private DriveSubsystem drive;

    public BlueMiddleShoot(VisionSubsystem vision, DriveSubsystem drive, IntakeSubsystem intake, StorageSubsystem storage, ShooterSubsystem shooter, TurretSubsystem turret) {
        ...
        Trajectory toShoot;
        try {
            toShoot = TrajectoryUtil.fromPathweaverJson(Paths.get("/home/lvuser/deploy/PathWeaver/Paths/output/BlueMiddleShoot.wpilib.json"));
        } catch (IOException e) {
            e.printStackTrace();
            toShoot = null;
        }
