...
public class RedMiddleShoot extends SequentialCommandGroup {

    private DriveSubsystem drive;

    public RedMiddleShoot(VisionSubsystem vision, DriveSubsystem drive, IntakeSubsystem intake, StorageSubsystem storage, ShooterSubsystem shooter, TurretSubsystem turret) {
