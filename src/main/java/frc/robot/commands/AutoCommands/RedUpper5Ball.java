...
public class RedUpper5Ball extends SequentialCommandGroup {

    private DriveSubsystem drive;

    public RedUpper5Ball(VisionSubsystem vision, DriveSubsystem drive, IntakeSubsystem intake,
        ...
        Trajectory path2;
        try {
            path1 = TrajectoryUtil.fromPathweaverJson(Paths.get("/home/lvuser/deploy/PathWeaver/output/rubs1-1.wpilib.json"));
            path2 = generateTrajectory(reverseConfig, new double[] {7.74, 3.048}, new double[] {-0.736, 0}, new double[] {3.97, 1.806}, new double[] {-2.491, 0});
        } catch (IOException e) {
            e.printStackTrace();
            path1 = null;
            path2 = null;
