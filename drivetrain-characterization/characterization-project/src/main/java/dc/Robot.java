...
public class Robot extends TimedRobot {
  ...
  static private double WHEEL_DIAMETER = 0.153;
  ...
  public void robotInit() {
    ...
    leftMaster = new WPI_TalonFX(8);
    leftMaster.setInverted(false);
    leftMaster.setSensorPhase(false);
    leftMaster.setNeutralMode(NeutralMode.Brake);

    rightMaster = new WPI_TalonFX(10);
    rightMaster.setInverted(false);
    rightMaster.setSensorPhase(false);
    rightMaster.setNeutralMode(NeutralMode.Brake);

    WPI_TalonFX leftSlave0 = new WPI_TalonFX(9);
    leftSlave0.setInverted(false);
    leftSlave0.follow(leftMaster);
    leftSlave0.setNeutralMode(NeutralMode.Brake);

    WPI_TalonFX rightSlave0 = new WPI_TalonFX(11);
